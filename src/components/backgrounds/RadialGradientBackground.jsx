    ...
    hero: [
      {
        ...
        colors: [
          { color: 'rgba(124, 58, 237, 0.25)', stop: '0%' },
          { color: 'rgba(124, 58, 237, 0.45)', stop: '25%' },
          { color: 'rgba(124, 58, 237, 0.5)', stop: '50%' },
          { color: 'rgba(124, 58, 237, 0.45)', stop: '75%' },
          { color: 'rgba(124, 58, 237, 0.25)', stop: '100%' },
        ],
        blur: '0px',
        opacity: 0.5,
      },
