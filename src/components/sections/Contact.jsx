                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea 
                                    ...
                                    onChange={handleChange}
                                    rows={5}
                                    className='w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300 min-h-[250px]'
                                    placeholder='Message'
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-white/60 leading-relaxed">
                                If you’re hiring or exploring a potential collaboration, I’d love to hear from you. I’m particularly interested in roles where I can contribute, learn, and grow while helping teams build meaningful products.
                        ...
                        <div className="space-y-4">
                            <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                                <div className="flex items-start gap-4">
                                    <div className="p-3 bg-linear-to-br from-primary/20 to-primary/30 rounded-2xl">
                                        <Mail className='h-6 w-6 text-primary' />
                                    </div>
                                    <div className="flex-1">
                                        <p className="text-sm text-white/60 mb-1">Email</p>
                                        <a href={`mailto:${PERSONAL_INFO.email}`} className='text-white hover:text-primary transition-colors font-medium capitalize'> 
                                            {PERSONAL_INFO.email}
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-4">
                                {Object.entries(SOCIAL_LINKS).map(([platform, urls]) =>{
